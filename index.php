...
<body>
	...
	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
				<a class="navbar-brand" href="uploaded_songs.php">
					Musical World
				</a>
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					...
					<a class="btn btn-agile  mt-4 scroll" href="uploaded_songs.php" role="button">Listen Songs</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card">
					<div class="card-body px-lg-5">
						...
						<p class="card-text align-self-center my-4 text-white">
							A basic site to upload music and sort it by language.
						</p>
						<p class="card-text align-self-center mb-5 text-white">Click on top left to start listening..</p>
						<a href="#more_info" class="btn btn-agile abt_card_btn scroll">SONGS</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			<h3 class="stat-title text-white">PROJECT DONE BY-</h3>
			<h2 class="stat-title text-white">AMAN DAS, KARTHIK REDDY</h2>
			<p class="text-white w-75 mx-auto">Musical World a unique platform to listen to songs.
			</p>
		</div>
	</div>
